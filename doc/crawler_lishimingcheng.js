...
function loadItems(page = 1, list = []) {
  // 加载网页
  const req = http.request('http://gl.ncha.gov.cn:8080/city/find', {
    method: 'POST'
  }, (res) => {
    var html = "";
    ...
    res.on("end", function () {
      ...
      res.data.data.forEach(item => {
        ...
        list.push({
          ...
          group: 'lishimingcheng',
          radioOptions: ['去过', '想去'],
          link: 'http://gl.ncha.gov.cn/#/Industry/Famous-historical'
        })
      })
      ...
      if (page < 7) {
        ...
        console.log(list[0])
        mpaUtils.writeToJsonFile(list, '../patch/20200817/lishimingcheng')
      }
    })
  })
