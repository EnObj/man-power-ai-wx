...
mpaUtils.request('http://baike.baidu.com/city/api/citylemmalist?type=2&cityId=33&offset=0&limit=100&t=1597650135061').then(html=>{
  ...
  console.log(list[0])
  mpaUtils.writeToJsonFile(list, '../patch/20200817/hangzhou-meishi')
})